...
{ 
  ...
  // G4String fileName = "ACE3_Data_original_1";
  // G4String filePath = "/home/zackashm/geant4/Projects/ACE3/" + fileName + ".root";
  // auto i{1};
  // while ( access(filePath.c_str(), F_OK) != -1 ) {
  //   i++;
  //   auto counter{static_cast<G4String>(std::to_string(i))}; 
  //   fileName = "ACE3_Data_original_" + counter;     // rename file
  //   filePath = "/home/zackashm/geant4/Projects/ACE3/" + fileName + ".root";
  //   // loop: check if new file exists
 
  // }
  
  // filename instructions for data
  G4String energies[7] = {"05", "1", "10", "50", "500", "1000"};//, "3000"};
                        // 0.5, 1, 10, 50, 500, 1000, 3000 GeV
  G4String fileName;
  G4String filePath;
  G4String runType = "nogap";
  for (auto const& i : energies) {
    fileName = "data/" + runType + "/ACE3_Data_" + runType + "_" + i;     // rename file
    filePath = "/home/zackashm/geant4/Projects/ACE3/" + fileName + ".root";
